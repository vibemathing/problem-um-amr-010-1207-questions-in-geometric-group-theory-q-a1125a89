...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-1207-questions-in-geometric-group-theory-q-a1125a89",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-1207-650f22cd0d6c",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-1207"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Which α preserve an order (invariant under right translations) on Fn? If α has periodic elements it cannot preserve an order. Are there other obstructions?",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 12.7",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "325572f33b98241c0db8b8af7debf9ad50474e4986371bdec611ead073dd783f"
}
```
